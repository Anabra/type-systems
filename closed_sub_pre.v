...
Lemma ifThenElseFalse {t1 t2 : Tm} :
  Closed t1 -> Closed t2 ->
...
Lemma ifThenElseTrue {t1 t2 : Tm} :
  Closed t1 -> Closed t2 ->
  (ifThenElse $ true $ t1 $ t2) |-->* t1.
Proof.
  (* TODO: First part is similar to ifThenElseFalse, then use closedSubstitute *)
Admitted.
